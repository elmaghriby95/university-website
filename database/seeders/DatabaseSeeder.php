...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Slider::query()->updateOrCreate(
            ...
            [
                'subtitle' => 'أقسام متعددة وبرامج حديثة وخدمات طلابية متكاملة',
                'button_text' => 'استكشف الأقسام',
        ...
        $faculties = [
            ['name' => 'قسم الهندسة', 'slug' => 'engineering', 'dean' => 'د. أحمد المنصوري', 'students_count' => 2100, 'departments_count' => 6, 'sort_order' => 1],
            ['name' => 'قسم الطب', 'slug' => 'medicine', 'dean' => 'د. سعاد الزوي', 'students_count' => 1800, 'departments_count' => 5, 'sort_order' => 2],
            ['name' => 'قسم تقنية المعلومات', 'slug' => 'it', 'dean' => 'د. خالد العرفي', 'students_count' => 1600, 'departments_count' => 4, 'sort_order' => 3],
            ['name' => 'قسم العلوم', 'slug' => 'science', 'dean' => 'د. فاطمة الشريف', 'students_count' => 1400, 'departments_count' => 5, 'sort_order' => 4],
            ['name' => 'قسم الاقتصاد', 'slug' => 'economics', 'dean' => 'د. محمد التومي', 'students_count' => 2200, 'departments_count' => 4, 'sort_order' => 5],
            ['name' => 'قسم الآداب', 'slug' => 'arts', 'dean' => 'د. نادية القماطي', 'students_count' => 1900, 'departments_count' => 7, 'sort_order' => 6],
        ];
        ...
        foreach ($faculties as $faculty) {
            Faculty::query()->updateOrCreate(
                ['slug' => $faculty['slug']],
                array_merge($faculty, [
                    'description' => 'يقدم القسم برامج أكاديمية متميزة تجمع بين الجانب النظري والتطبيقي، وتهدف إلى إعداد خريجين مؤهلين لسوق العمل وقادرين على الإسهام في البحث العلمي وخدمة المجتمع.',
                    'is_active' => true,
                ])
            );
        }
        ...
        News::query()->updateOrCreate(
            ...
            [
                ...
                'excerpt' => 'تنظم الجامعة يوماً مفتوحاً للتعريف بالأقسام وبرامج القبول.',
                'content' => "تنظم عمادة شؤون الطلاب يوماً مفتوحاً للطلبة الجدد وأولياء الأمور للتعريف بالأقسام والخدمات الجامعية وآليات القبول والتسجيل.\n\nويتضمن البرنامج جولات تعريفية ومحاضرات إرشادية ومعارض للأقسام.",
                'is_published' => true,
                'is_featured' => false,
        ...
        Event::query()->updateOrCreate(
            ...
            [
                ...
                'content' => 'يشمل الأسبوع محاضرات تعريفية وورش عمل ولقاءات مع رؤساء الأقسام.',
